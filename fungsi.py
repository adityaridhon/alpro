...
class ToDoListApp(QWidget):
    ...
    def show_completed_tasks(self):
        ...
        completed_tasks_window.setGeometry(250, 100, 800, 600)
        # style history window
        completed_tasks_window.setStyleSheet("""
...
""")
    ...
    def initUI(self):
        ...
        self.setGeometry(250, 100, 800, 600) #Ukuran window awal
        self.setStyleSheet("""
        #frame {
            background-color: qlineargradient(x1: 0, x2: 1, stop: 0 #190482, stop: 1 #7752FE)
        }
    """)
        ...
        title_label.setStyleSheet("color: white;  margin-bottom: 30px;")

        font = QFont('Poppins', 40, QFont.Bold)
    ...
    """)
        ...
        # kerjakanbtn
        self.work_button = QPushButton('Kerjakan Tugas', self)
        self.work_button.setObjectName("workbtn")
        self.work_button.clicked.connect(self.open_timer_window)
    ...
    """)
        ...
        self.complete_button.setObjectName("donebtn")
...
""")
        ...
        history_button.setObjectName("historybtn")
